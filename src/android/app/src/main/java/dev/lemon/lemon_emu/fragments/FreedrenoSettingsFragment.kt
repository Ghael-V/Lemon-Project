...
import dev.lemon.lemon_emu.adapters.FreedrenoPresetAdapter
import dev.lemon.lemon_emu.adapters.FreedrenoVariableAdapter
import dev.lemon.lemon_emu.databinding.FragmentFreedrenoSettingsBinding
import dev.lemon.lemon_emu.model.Game
import dev.lemon.lemon_emu.utils.NativeFreedrenoConfig
import dev.lemon.lemon_emu.utils.FreedrenoPresets
...
class FreedrenoSettingsFragment : Fragment() {
    ...
    private fun applyPreset(preset: dev.lemon.lemon_emu.utils.FreedrenoPreset) {
