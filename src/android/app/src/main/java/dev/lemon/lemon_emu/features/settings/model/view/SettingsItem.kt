...
package dev.lemon.lemon_emu.features.settings.model.view
...
import dev.lemon.lemon_emu.features.input.model.NpadStyleIndex
...
import dev.lemon.lemon_emu.features.settings.model.ByteSetting
import dev.lemon.lemon_emu.features.settings.model.IntSetting
import dev.lemon.lemon_emu.features.settings.model.LongSetting
...
abstract class SettingsItem(
    ...
    val title: String by lazy {
        if (titleId != 0) {
            return@lazy LemonApplication.appContext.getString(titleId)
        }
    ...
    val description: String by lazy {
        if (descriptionId != 0) {
            return@lazy LemonApplication.appContext.getString(descriptionId)
        }
