...
object ThemeHelper {
        ...
        when (Theme.from(IntSetting.THEME.getInt())) {
            ...
            Theme.MaterialYou -> {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
                    activity.setTheme(R.style.Theme_Lemon_Main_MaterialYou)
                } else {
    ...
    private fun getSelectedStaticThemeColor(): Int {
        ...
        val themes = arrayOf(
            R.style.Theme_Lemon_Main,
            R.style.Theme_Lemon_Main_Violet,
            R.style.Theme_Lemon_Main_Blue,
            R.style.Theme_Lemon_Main_Cyan,
            R.style.Theme_Lemon_Main_Red,
            R.style.Theme_Lemon_Main_Green,
            R.style.Theme_Lemon_Main_Yellow,
            R.style.Theme_Lemon_Main_Orange,
            R.style.Theme_Lemon_Main_Pink,
            R.style.Theme_Lemon_Main_Gray
        )
