...
import dev.lemon.lemon_emu.adapters.AbstractListAdapter
import dev.lemon.lemon_emu.databinding.ListItemInputProfileBinding
...
data class NewProfileItem(
    ...
    override val name: String = LemonApplication.appContext.getString(R.string.create_new_profile)
}
