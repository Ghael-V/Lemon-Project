...
import dev.lemon.lemon_emu.features.input.model.InputType
import dev.lemon.lemon_emu.features.input.model.ButtonName
...
object NativeInput {
     ...
     * @param device An [InputDevice] or the input overlay wrapped with [LemonInputDevice]
     */
    external fun registerController(device: LemonInputDevice)
