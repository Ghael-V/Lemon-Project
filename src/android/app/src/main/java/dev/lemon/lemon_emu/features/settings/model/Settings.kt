...
package dev.lemon.lemon_emu.features.settings.model
...
object Settings {
    ...
    fun getPlayerString(player: Int): String =
        LemonApplication.appContext.getString(R.string.preferences_player, player)

    fun GetDebugKnobAt(index: Int): Boolean {
        return dev.lemon.lemon_emu.NativeLibrary.GetDebugKnobAt(index)
    }
