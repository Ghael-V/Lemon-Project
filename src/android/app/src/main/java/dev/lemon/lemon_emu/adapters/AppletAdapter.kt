...
import dev.lemon.lemon_emu.databinding.CardSimpleOutlinedBinding
import dev.lemon.lemon_emu.model.Applet
...
class AppletAdapter(val activity: FragmentActivity, applets: List<Applet>) :
    ...
    inner class AppletViewHolder(val binding: CardSimpleOutlinedBinding) :
        ...
        fun onClick(applet: Applet) {
            ...
            val appletGame = Game(
                title = LemonApplication.appContext.getString(applet.titleId),
                path = appletPath
            )
