...
import dev.lemon.lemon_emu.model.TaskViewModel
import dev.lemon.lemon_emu.utils.*
...
import dev.lemon.lemon_emu.updater.APKDownloader
import dev.lemon.lemon_emu.updater.APKInstaller
...
class MainActivity : AppCompatActivity(), ThemeProvider {
    ...
    fun processExternalContentDir(result: Uri) {
        ...
        val folder = gamesViewModel.folders.value.firstOrNull {
            it.uriString == uriString && it.type == dev.lemon.lemon_emu.model.DirectoryType.EXTERNAL_CONTENT
        }
        if (folder != null) {
            Toast.makeText(
                applicationContext,
        ...
        val externalContentDir = dev.lemon.lemon_emu.model.GameDir(uriString, false, dev.lemon.lemon_emu.model.DirectoryType.EXTERNAL_CONTENT)
