...
package dev.lemon.lemon_emu.views
...
class GradientBorderCardView @JvmOverloads constructor(
    ...
    private var isLemonTheme = false
    ...
    override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
        ...
        if (isLemonTheme) {
            // Gradient for Lemon theme
            borderPaint.shader = LinearGradient(
                0f,
                0f,
                w.toFloat(),
                h.toFloat(),
                context.getColor(R.color.lemon_border_gradient_start),
                context.getColor(R.color.lemon_border_gradient_end),
