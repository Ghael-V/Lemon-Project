...
package dev.lemon.lemon_emu.activities
...
import dev.lemon.lemon_emu.fragments.EmulationFragment
import dev.lemon.lemon_emu.utils.CustomSettingsHandler
...
import dev.lemon.lemon_emu.databinding.ActivityEmulationBinding
...
import dev.lemon.lemon_emu.model.EmulationViewModel
import dev.lemon.lemon_emu.model.Game
import dev.lemon.lemon_emu.network.NetPlayManager
...
import dev.lemon.lemon_emu.utils.NfcReader
import dev.lemon.lemon_emu.utils.ParamPackage
import dev.lemon.lemon_emu.utils.ThemeHelper
import java.text.NumberFormat
import kotlin.math.roundToInt
import dev.lemon.lemon_emu.utils.ForegroundService
...
class EmulationActivity : AppCompatActivity(), SensorEventListener, InputManager.InputDeviceListener {
    ...
    override fun attachBaseContext(base: Context) {
        super.attachBaseContext(LemonApplication.applyLanguage(base))
    }
    ...
    private fun notifyControllerInput() {
        ...
        val emulationFragment =
            navHostFragment?.childFragmentManager?.fragments?.firstOrNull() as? dev.lemon.lemon_emu.fragments.EmulationFragment
    ...
    override fun dispatchTouchEvent(event: MotionEvent): Boolean {
        ...
        val emulationFragment = navHostFragment?.childFragmentManager?.fragments?.firstOrNull() as? dev.lemon.lemon_emu.fragments.EmulationFragment
