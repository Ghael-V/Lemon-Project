...
import dev.lemon.lemon_emu.databinding.DialogOverlayAdjustBinding
import dev.lemon.lemon_emu.databinding.FragmentEmulationBinding
import dev.lemon.lemon_emu.dialogs.QuickSettings
...
import dev.lemon.lemon_emu.features.settings.model.Settings.EmulationOrientation
import dev.lemon.lemon_emu.features.settings.model.Settings.EmulationVerticalAlignment
                ...
                if (emulationViewModel.emulationStarted.value &&
                    ...
                    if (BooleanSetting.PERF_OVERLAY_BACKGROUND.getBoolean(needsGlobal)) {
                        binding.showStatsOverlayText.setBackgroundResource(
                            R.color.lemon_transparent_black
                        )
                    } else {
