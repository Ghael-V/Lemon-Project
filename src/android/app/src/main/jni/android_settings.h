...
namespace AndroidSettings {
    ...
    struct Values {
        ...
        // AppCompatDelegate.MODE_NIGHT_YES: dark by default for new installs.
        ...
        // On by default - checking for updates is expected behavior, not an opt-in feature,
        // and every code path that calls checkForUpdate() already requires the user to
        // confirm before anything actually downloads/installs.
