...
void Java_dev_lemon_lemon_1emu_utils_NativeConfig_initializeGlobalConfig(JNIEnv* env, jobject obj) {
    global_config = std::make_unique<AndroidConfig>();
    FrontendCommon::GenerateSettings();
    ResetFxChainToGlobal();
}

void Java_dev_lemon_lemon_1emu_utils_NativeConfig_unloadGlobalConfig(JNIEnv* env, jobject obj) {
    global_config.reset();
}
...
void Java_dev_lemon_lemon_1emu_utils_NativeConfig_initializePerGameConfig(JNIEnv* env, jobject obj,
                                                                        jstring jprogramId,
                                                                        jstring jfileName) {
...
jboolean Java_dev_lemon_lemon_1emu_utils_NativeConfig_isPerGameConfigLoaded(JNIEnv* env,
                                                                          jobject obj) {
...
void Java_dev_lemon_lemon_1emu_utils_NativeConfig_unloadPerGameConfig(JNIEnv* env, jobject obj) {
    per_game_config.reset();
}

jboolean Java_dev_lemon_lemon_1emu_utils_NativeConfig_getBoolean(JNIEnv* env, jobject obj,
...
void Java_dev_lemon_lemon_1emu_utils_NativeConfig_setBoolean(JNIEnv* env, jobject obj, jstring jkey,
                                                           jboolean value) {
    auto setting = getSetting<bool>(env, jkey);
    if (setting == nullptr) {
        return;
...
jbyte Java_dev_lemon_lemon_1emu_utils_NativeConfig_getByte(JNIEnv* env, jobject obj, jstring jkey,
                                                         jboolean needGlobal) {
...
void Java_dev_lemon_lemon_1emu_utils_NativeConfig_setByte(JNIEnv* env, jobject obj, jstring jkey,
                                                        jbyte value) {
    auto setting = getSetting<u8>(env, jkey);
    if (setting == nullptr) {
        return;
...
jshort Java_dev_lemon_lemon_1emu_utils_NativeConfig_getShort(JNIEnv* env, jobject obj, jstring jkey,
                                                           jboolean needGlobal) {
...
void Java_dev_lemon_lemon_1emu_utils_NativeConfig_setShort(JNIEnv* env, jobject obj, jstring jkey,
                                                         jshort value) {
    auto setting = getSetting<u16>(env, jkey);
    if (setting == nullptr) {
        return;
...
jint Java_dev_lemon_lemon_1emu_utils_NativeConfig_getUnsignedShort(JNIEnv* env, jobject obj,
                                                                 jstring jkey,
                                                                 jboolean needGlobal) {
    auto setting = getSetting<u16>(env, jkey);
    if (setting == nullptr) {
...
void Java_dev_lemon_lemon_1emu_utils_NativeConfig_setUnsignedShort(JNIEnv* env, jobject obj,
...
jint Java_dev_lemon_lemon_1emu_utils_NativeConfig_getInt(JNIEnv* env, jobject obj, jstring jkey,
                                                       jboolean needGlobal) {
...
void Java_dev_lemon_lemon_1emu_utils_NativeConfig_setInt(JNIEnv* env, jobject obj, jstring jkey,
                                                       jint value) {
    auto setting = getSetting<int>(env, jkey);
    if (setting == nullptr) {
        return;
...
jfloat Java_dev_lemon_lemon_1emu_utils_NativeConfig_getFloat(JNIEnv* env, jobject obj, jstring jkey,
                                                           jboolean needGlobal) {
...
void Java_dev_lemon_lemon_1emu_utils_NativeConfig_setFloat(JNIEnv* env, jobject obj, jstring jkey,
                                                         jfloat value) {
    auto setting = getSetting<float>(env, jkey);
    if (setting == nullptr) {
        return;
...
jlong Java_dev_lemon_lemon_1emu_utils_NativeConfig_getLong(JNIEnv* env, jobject obj, jstring jkey,
                                                         jboolean needGlobal) {
...
void Java_dev_lemon_lemon_1emu_utils_NativeConfig_setLong(JNIEnv* env, jobject obj, jstring jkey,
                                                        jlong value) {
...
jstring Java_dev_lemon_lemon_1emu_utils_NativeConfig_getString(JNIEnv* env, jobject obj, jstring jkey,
                                                             jboolean needGlobal) {
...
void Java_dev_lemon_lemon_1emu_utils_NativeConfig_setString(JNIEnv* env, jobject obj, jstring jkey,
                                                          jstring value) {
    auto setting = getSetting<std::string>(env, jkey);
    if (setting == nullptr) {
        return;
...
jboolean Java_dev_lemon_lemon_1emu_utils_NativeConfig_getIsRuntimeModifiable(JNIEnv* env, jobject obj,
                                                                           jstring jkey) {
    auto setting = getSetting<std::string>(env, jkey);
    if (setting != nullptr) {
...
jstring Java_dev_lemon_lemon_1emu_utils_NativeConfig_getPairedSettingKey(JNIEnv* env, jobject obj,
                                                                       jstring jkey) {
    auto setting = getSetting<std::string>(env, jkey);
    if (setting == nullptr) {
        return Common::Android::ToJString(env, "");
...
jboolean Java_dev_lemon_lemon_1emu_utils_NativeConfig_getIsSwitchable(JNIEnv* env, jobject obj,
                                                                    jstring jkey) {
    auto setting = getSetting<std::string>(env, jkey);
    if (setting != nullptr) {
...
jboolean Java_dev_lemon_lemon_1emu_utils_NativeConfig_usingGlobal(JNIEnv* env, jobject obj,
                                                                jstring jkey) {
    auto setting = getSetting<std::string>(env, jkey);
    if (setting != nullptr) {
...
void Java_dev_lemon_lemon_1emu_utils_NativeConfig_setGlobal(JNIEnv* env, jobject obj, jstring jkey,
                                                          jboolean global) {
    auto setting = getSetting<std::string>(env, jkey);
    if (setting != nullptr) {
...
jboolean Java_dev_lemon_lemon_1emu_utils_NativeConfig_getIsSaveable(JNIEnv* env, jobject obj,
                                                                  jstring jkey) {
    auto setting = getSetting<std::string>(env, jkey);
    if (setting != nullptr) {
        return setting->Save();
...
jstring Java_dev_lemon_lemon_1emu_utils_NativeConfig_getDefaultToString(JNIEnv* env, jobject obj,
                                                                      jstring jkey) {
    auto setting = getSetting<std::string>(env, jkey);
    if (setting != nullptr) {
...
jobjectArray Java_dev_lemon_lemon_1emu_utils_NativeConfig_getGameDirs(JNIEnv* env, jobject obj) {
...
void Java_dev_lemon_lemon_1emu_utils_NativeConfig_setGameDirs(JNIEnv* env, jobject obj,
...
void Java_dev_lemon_lemon_1emu_utils_NativeConfig_addGameDir(JNIEnv* env, jobject obj,
                                                           jobject gameDir) {
    jclass gameDirClass = Common::Android::GetGameDirClass();
    jfieldID uriStringField = env->GetFieldID(gameDirClass, "uriString", "Ljava/lang/String;");
    jfieldID deepScanBooleanField = env->GetFieldID(gameDirClass, "deepScan", "Z");
...
jobjectArray Java_dev_lemon_lemon_1emu_utils_NativeConfig_getDisabledAddons(JNIEnv* env, jobject obj,
                                                                          jstring jprogramId) {
    auto program_id = EmulationSession::GetProgramId(env, jprogramId);
...
void Java_dev_lemon_lemon_1emu_utils_NativeConfig_setDisabledAddons(JNIEnv* env, jobject obj,
                                                                  jstring jprogramId,
...
void Java_dev_lemon_lemon_1emu_utils_NativeConfig_setInputSettings(JNIEnv* env, jobject obj,
...
jstring Java_dev_lemon_lemon_1emu_utils_NativeConfig_getSaveDir(JNIEnv* env, jobject obj) {
    return Common::Android::ToJString(env,
        Common::FS::GetEdenPathString(Common::FS::EdenPath::SaveDir));
}

jstring Java_dev_lemon_lemon_1emu_utils_NativeConfig_getDefaultSaveDir(JNIEnv* env, jobject obj) {
    return Common::Android::ToJString(env,
        Common::FS::GetEdenPathString(Common::FS::EdenPath::NANDDir));
}

void Java_dev_lemon_lemon_1emu_utils_NativeConfig_setSaveDir(JNIEnv* env, jobject obj, jstring jpath) {
    auto path = Common::Android::GetJString(env, jpath);
    Common::FS::SetEdenPath(Common::FS::EdenPath::SaveDir, path);
}

jstring Java_dev_lemon_lemon_1emu_utils_NativeConfig_getNandDir(JNIEnv* env, jobject obj) {
    return Common::Android::ToJString(env,
        Common::FS::GetEdenPathString(Common::FS::EdenPath::NANDDir));
}

void Java_dev_lemon_lemon_1emu_utils_NativeConfig_setNandDir(JNIEnv* env, jobject obj, jstring jpath) {
    auto path = Common::Android::GetJString(env, jpath);
    Common::FS::SetEdenPath(Common::FS::EdenPath::NANDDir, path);
}

jstring Java_dev_lemon_lemon_1emu_utils_NativeConfig_getSdmcDir(JNIEnv* env, jobject obj) {
    return Common::Android::ToJString(env,
        Common::FS::GetEdenPathString(Common::FS::EdenPath::SDMCDir));
}

void Java_dev_lemon_lemon_1emu_utils_NativeConfig_setSdmcDir(JNIEnv* env, jobject obj, jstring jpath) {
    auto path = Common::Android::GetJString(env, jpath);
    Common::FS::SetEdenPath(Common::FS::EdenPath::SDMCDir, path);
}

jobjectArray Java_dev_lemon_lemon_1emu_utils_NativeConfig_getExternalContentDirs(JNIEnv* env,
                                                                               jobject obj) {
...
void Java_dev_lemon_lemon_1emu_utils_NativeConfig_setExternalContentDirs(JNIEnv* env, jobject obj,
                                                                       jobjectArray jdirs) {
